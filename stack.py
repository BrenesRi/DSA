#So stacks basically are like a vector on an array, but following LIFO
#Last In, first out

#The first problem related to this will be using hashmaps and a stack for comparision
